...
from gmsh_utils_sol import (
    border_dofs_from_tags, build_2d_rectangle_mesh, gmsh_init, gmsh_finalize,
    prepare_quadrature_and_basis, get_jacobians,
    mesh1, mesh2, meshSol
)
from stiffness_sol import assemble_stiffness_and_rhs, assemble_stiffness_and_rhs_node_wide
from dirichlet import solve_dirichlet
from errors_sol import compute_L2_H1_errors
...
def main(L, H, h, order):
    ...
    elemType, nodeTags, nodeCoords, elemTags, elemNodeTags, bnds, bnds_tags= meshSol(L=2, H=1, order=order, smin=0.01, smax=0.1, dmin=0, dmax=0.3)
    ...
    # K_lil, F = assemble_stiffness_and_rhs_node_wide(elemTags, elemNodeTags, jac, det, coords, w, N, gN, kappa, f, tag_to_dof)
